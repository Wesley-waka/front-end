    ...
    >
      <div style={{ paddingTop: "10px", marginLeft:"300px", marginRight:"300px", paddingLeft:"200px"}}>
                  <form>
                          ...
                          <div class="mb-6">
                            <label for="resource-type" class="block mb-2 text-sm font-medium text-black">
                              Resource type
                            </label>
                            <select id="resource-type" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                          ...
                          <div class="mb-6">
                            <label for="resource-link" class="block mb-2 text-sm font-medium text-black">
                              Resource link
                            </label>
                            <input type="url" id="resource-link" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
                          </div>
                          <div class="mb-6">
                            <label for="comments" class="block mb-2 text-sm font-medium text-black">
                              Comments
                            </label>
